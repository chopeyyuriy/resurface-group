...
(function () {
  ...
  calendar.bgColor = '#BF3D97';
  calendar.dragBgColor = '#BF3D97';
  calendar.borderColor = '#BF3D97';
...
(function (window, Calendar) {
  ...
  var themeConfig = {
    'common.holiday.color': '#f96a6c',
    'month.holidayExceptThisMonth.color': 'rgba(249, 106, 108, 0.4);'
  };
  ...
  function setDropdownCalendarType() {
    var calendarTypeName = document.getElementById('calendarTypeName'); // var calendarTypeIcon = document.getElementById('calendarTypeIcon');
    ...
    calendarTypeName.innerHTML = type; // calendarTypeIcon.className = iconClassName;
  }
  ...
  function setSchedules() {// cal.clear();
