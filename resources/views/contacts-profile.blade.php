                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <h5 class="font-size-15 text-truncate">{{ data_get(Auth::user(), 'name') }}</h5>
                        ...
                        <table class="table table-nowrap mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ data_get(Auth::user(), 'name') }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Birthdate :</th>
                                    <td>{{ date('d-m-Y', strtotime(data_get(Auth::user(), 'dob'))) }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">E-mail :</th>
                                    <td>{{ data_get(Auth::user(), 'email') }}</td>
                                </tr>
                                <tr>
